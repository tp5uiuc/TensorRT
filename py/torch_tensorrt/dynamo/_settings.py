...
class CompilationSettings:
    ...
    Args:
        ...
        dynamic_shapes_kernel_specialization_strategy (str): TensorRT-RTX dynamic shapes kernel specialization strategy: "lazy" (default, compile specialized kernels in background and use fallbacks until ready), "eager" (compile specialized kernels synchronously, blocking first inference), or "none" (always use fallback kernels). Not used for standard TensorRT.
