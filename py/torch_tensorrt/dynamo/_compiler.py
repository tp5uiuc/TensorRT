...
def cross_compile_for_windows(
    ...
    **kwargs: Any,
    ...
    Keyword Arguments:
        ...
        use_python_runtime: (bool): Return a graph using a pure Python runtime. The default is ``False``, which uses the C++ runtime when available and falls back to Python automatically.
